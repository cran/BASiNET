...
In order for the rJava package to work properly, you must have installed JDK java(http://www.oracle.com/technetwork/java/javase/downloads/jdk10-downloads-4416644.html) and JRE java(http://www.oracle.com/technetwork/pt/java/javase/downloads/jre8-downloads-2133155.html). 
...
predicting - Directory of an FASTA file containing RNA sequences. These sequences will be predicted based on the .dat file selected by the parameter "load". By default is NULL.
